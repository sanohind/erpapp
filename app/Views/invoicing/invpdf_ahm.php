            ...
            <table width="100%" style="border-collapse: collapse;" border="0">
                <thead>
                    <tr style="border-top: 1px solid black;">
                        <th style="border-bottom: 1px solid black; border-left: 1px solid #000; border-right: 1px solid #000;">QUANTITY</th>
                        <th style="border-bottom: 1px solid black; border-left: 1px solid #000; border-right: 1px solid #000;">DESCRIPTION </th>
                        <th style="border-bottom: 1px solid black; border-left: 1px solid #000; border-right: 1px solid #000;">PRICE / UNIT</th>
                        <th style="border-bottom: 1px solid black; border-left: 1px solid #000; border-right: 1px solid #000;">AMOUNT</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
